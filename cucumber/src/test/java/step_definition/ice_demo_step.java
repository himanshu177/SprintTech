...
public class ice_demo_step {
	...
	public void logout() throws Exception {
		wd.findElement(By.xpath("/html[1]/body[1]/header[1]/nav[1]/div[2]/ul[1]/li[4]/a[1]")).click();
		Thread.sleep(5000);
		wd.findElement(By.xpath("/html[1]/body[1]/header[1]/nav[1]/div[2]/ul[1]/li[4]/ul[1]/li[2]/div[2]/a[1]")).click();
